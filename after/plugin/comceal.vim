...
"
" 1. g:comceal_char        -- character which can be used in place of comment --
"                             for more check :help ccchar
" 2. g:comceal_list        -- conceal levels to toggle between when using the
"                             Comceal command -- for more check :help conceallevel
" 3. g:comceal_default     -- the comment string to assume if the file type is
"                             not recognised by vim
" 4. g:comceal_disabled    -- to disable this plugin
" 5. g:comceal_start_level -- define an alternative start conceal level,
"                             else will use currently set &conceallevel
